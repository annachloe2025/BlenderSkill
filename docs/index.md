...
| 項目 | 内容 |
|---|---|
| **フェーズ** | Phase 4 ライティング・レンダリング編 完了 |
| **最終更新** | 2026-05-04 |
| **直近の動き** | **ライト4種 / Sky Texture / Cycles vs Eevee / 被写界深度 を全部消化** |
| **次のアクション** | Phase 5（アニメ / パーティクル / ジオメトリノード / AI生成モデル）|

## 🪑 直近の成果

![被写界深度の効いた5色球（Cycles, 50mm f/2.0）](images/dof_spheres.png)

*Phase 4 完了。手前にピント・奥はボケのDoFで作品感が一気に出た。[ライト4種比較](snippets/light_comparison.md) / [Sky Texture](snippets/sky_environment.md) / [Cycles vs Eevee](snippets/cycles_vs_eevee.md) / [DoF](snippets/camera_dof.md)*
...
| 5 | 応用編（アニメ・パーティクル・ジオメトリノード・AI生成）| 🟢 次に着手 |
